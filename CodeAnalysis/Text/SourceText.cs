...
namespace Jvav.CodeAnalysis.Text;
public sealed class SourceText
{
    ...
    private static void AddLine(ImmutableArray<TextLine>.Builder result, SourceText sourceText, int position, int lineStart, int lineBreakWidth)
    {
        ...
        var lineLengthIcludingLineBreak = lineLength + lineBreakWidth;
        var line = new TextLine(sourceText, lineStart, lineLength, lineLengthIcludingLineBreak);
        result.Add(line);
    }
